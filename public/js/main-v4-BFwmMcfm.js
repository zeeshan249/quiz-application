const __vite__mapDeps = (
    ...
    d = m.f ||
        (m.f = [
            "js/vendor-echarts-hUIyzMbB.js",
            "js/rolldown-runtime-DEgBLETi.js",
            "js/vendor-tables-Yd668bHn.js",
            "js/inbox-Cn00kCck.js",
            "js/toast-DgCSlJPv.js",
            "js/modal-MTuCfURV.js",
            "js/data-adapter-B-GF0xCf.js",
            "js/calendar-reenTeUh.js",
            "js/settings-7ogjg0JM.js",
        ])
) => i.map((i) => d[i]);
import { t as e } from "./toast-DgCSlJPv.js";
import { n as t, r as o, t as r } from "./menus-BVcs0GJR.js";
import { n as a } from "./modal-MTuCfURV.js";
!(function () {
            ...
            (t) =>
                `\n    <div class="nav-group">\n      <div class="nav-label">${t.label}</div>\n      ${t.items
                    .map((t) =>
                        (function (e, t) {
                            if (e.children) {
                                const o = e.children.some((e) => e.key === t),
                                    r = e.children
                                        .map((e) => {
                                            const o = e.key === t;
...
var p = [
        ...
        { kind: "info", from: "Notion", text: "You were mentioned in Q2 OKRs", time: "Yesterday", unread: !1 },
    ],
    u = [
        {
            from: "Sarah K.",
        ...
        if (t && t.length > 0) {
            ...
            (a = t.map((t) => {
                ...
                if (
                    ...
                    (t = import.meta.resolve ? import.meta.resolve(o) : new URL(o, import.meta.url).href) in g)
                )
                    return;
                g[t] = !0;
                ...
                return (
                    (a.rel = r ? "stylesheet" : "modulepreload"),
                    r || (a.as = "script"),
                    (a.crossOrigin = ""),
                    (a.href = t),
                    ...
                    r
                        ? new Promise((e, o) => {
                              a.addEventListener("load", e),
                                  a.addEventListener("error", () => o(new Error(`Unable to preload CSS for ${t}`)));
                          })
                        : void 0
                );
            })),
...
function v(e) {
    return {
        textStyle: { fontFamily: b, fontSize: 11, color: e.textMuted },
        ...
        tooltip: {
            ...
            borderWidth: 1,
            padding: [8, 10],
            textStyle: { color: e.text, fontSize: 12, fontFamily: b },
...
function x(e, t, o, r, a) {
    ...
    return (
        n.setOption({
            textStyle: { fontFamily: b, color: o.textMuted },
            tooltip: { ...v(o).tooltip, trigger: "item", formatter: "{b}: {d}%" },
            legend: { show: !1 },
            series: [
                {
                    type: "pie",
...
var w = {
    ...
    "revenue-line": function (e, t, o) {
        ...
        return (
            r.setOption({
                ...v(o),
                tooltip: { ...v(o).tooltip, trigger: "axis", valueFormatter: (e) => "$" + e.toLocaleString() },
                xAxis: {
                    type: "category",
                ...
                series: [
                    {
                        ...
                        smooth: !0,
                        showSymbol: !1,
                        data: [12400, 14200, 15600, 17800, 19200, 21500, 23100, 24800, 26200, 27900, 29400, 30100],
                        lineStyle: { color: o.primary, width: 2 },
    ...
    "sales-bar": function (e, t, o) {
        ...
        return (
            a.setOption({
                ...v(o),
                grid: { ...v(o).grid, left: 28 },
                tooltip: { ...v(o).tooltip, trigger: "axis", axisPointer: { type: "shadow" } },
                xAxis: {
                    type: "category",
    ...
    "stacked-area": function (e, t, o) {
        ...
        return (
            a.setOption({
                ...v(o),
                tooltip: { ...v(o).tooltip, trigger: "axis" },
                legend: {
                    data: r.map((e) => e.name),
                    bottom: 0,
                    itemGap: 16,
    ...
    "horizontal-bar": function (e, t, o) {
        ...
        return (
            a.setOption({
                ...
                grid: { ...v(o).grid, left: 90, right: 24 },
                xAxis: {
                    type: "value",
                    splitLine: { lineStyle: { color: o.borderLight, type: [4, 3] } },
                    axisLine: { show: !1 },
    ...
    "mixed-bar-line": function (e, t, o) {
        ...
        return (
            r.setOption({
                ...
                grid: { ...v(o).grid, right: 44, bottom: 36 },
                xAxis: {
                    type: "category",
    ...
    radar: function (e, t, o) {
        ...
        return (
            r.setOption({
                textStyle: { fontFamily: b, color: o.textMuted },
                tooltip: { ...v(o).tooltip, trigger: "item" },
                legend: {
                    data: ["v3", "v4"],
                    bottom: 0,
                    itemGap: 16,
    ...
    scatter: function (e, t, o) {
        ...
        return (
            r.setOption({
                ...
                grid: { ...v(o).grid, left: 40, right: 24 },
                xAxis: {
                    type: "value",
                    name: "Hours/week",
                    nameTextStyle: { color: o.textMuted, fontSize: 10 },
        ...
        for (let l = 0; r.length > l; l += 1)
            for (let e = 0; a.length > e; e += 1) {
                const t = 1 - Math.abs(e - 4) / 6,
                    ...
                    a = Math.max(0, Math.round(t * o * r * 100));
                n.push([e, l, a]);
            }
        const i = e.init(t);
        return (
            i.setOption({
                ...
                tooltip: {
                    ...v(o).tooltip,
                    formatter: (e) => `${r[e.value[1]]} ${a[e.value[0]]}:00<br><strong>${e.value[2]}</strong> events`,
                },
    ...
    funnel: function (e, t, o) {
        ...
        return (
            r.setOption({
                textStyle: { fontFamily: b, color: o.textMuted },
                tooltip: { ...v(o).tooltip, trigger: "item", formatter: "{b}: {c}" },
                series: [
                    {
                        type: "funnel",
                        left: 24,
    ...
    candlestick: function (e, t, o) {
        ...
        return (
            n.setOption({
                ...v(o),
                tooltip: { ...v(o).tooltip, trigger: "axis", axisPointer: { type: "cross" } },
                grid: { ...v(o).grid, left: 40, right: 24 },
                xAxis: {
                    type: "category",
                    data: a,
    ...
    treemap: function (e, t, o) {
        ...
        return (
            r.setOption({
                textStyle: { fontFamily: b, color: o.textMuted },
                tooltip: { ...v(o).tooltip, formatter: (e) => `${e.name}: ${e.value.toLocaleString()}` },
                series: [
                    {
                        type: "treemap",
                        roam: !1,
                        nodeClick: !1,
                        breadcrumb: { show: !1 },
                        label: { show: !0, color: "#fff", fontSize: 11, fontWeight: 600, fontFamily: b },
                ...
                series: [
                    {
                        ...
                        label: { color: o.text, fontSize: 11, fontFamily: b },
    ...
    "calendar-heatmap": function (e, t, o) {
        const r = new Date(),
            a = new Date(r);
        a.setMonth(a.getMonth() - 11), a.setDate(1);
        const n = [];
        for (let l = new Date(a); r >= l; l.setDate(l.getDate() + 1)) {
            const e = l.getDay(),
                t = Math.max(0, Math.round((1 > e || e > 5 ? 0.4 : 1) * (100 * Math.random())));
            n.push([l.toISOString().slice(0, 10), t]);
        }
        const i = e.init(t);
        return (
            i.setOption({
                textStyle: { fontFamily: b, color: o.textMuted },
                tooltip: { ...v(o).tooltip, formatter: (e) => `${e.value[0]}: ${e.value[1]} contributions` },
                visualMap: { min: 0, max: 100, show: !1, inRange: { color: [o.borderLight, o.primary, o.primaryDk] } },
                calendar: {
                    top: 30,
                    left: 24,
                    right: 24,
                    bottom: 12,
                    cellSize: ["auto", 14],
                    range: [a.toISOString().slice(0, 7), r.toISOString().slice(0, 10)],
                    itemStyle: {
                    ...
                    splitLine: { show: !1 },
                    yearLabel: { show: !1 },
                    monthLabel: { color: o.textMuted, fontSize: 10, fontFamily: b },
                    dayLabel: { color: o.textMuted, fontSize: 10, fontFamily: b, firstDay: 1 },
                },
                series: { type: "heatmap", coordinateSystem: "calendar", data: n },
            }),
            i
        );
    },
    gantt: function (e, t, o) {
        const r = new Date(),
            ...
            n = [
                [0, a(-12), a(-2), "Discovery & research", o.azure],
                [1, a(-8), a(8), "Design system v4", o.primary],
                [2, a(-3), a(14), "Build inbox", o.purple],
                [3, a(2), a(10), "Build kanban", o.yellow],
                [4, a(7), a(20), "Charts gallery", o.green],
                [5, a(14), a(28), "Theme generator", o.red],
                [6, a(20), a(35), "PWA + screenshots", o.cyan],
            ],
            i = n.map((e) => e[3]),
            l = e.init(t);
        return (
            l.setOption({
                ...
                tooltip: {
                    ...
                    formatter: (e) => {
                        const [, t, o, r] = e.value,
                            a = (e) => new Date(e).toLocaleDateString("en-US", { month: "short", day: "numeric" });
                        return `<strong>${r}</strong><br>${a(t)} → ${a(o)}`;
                    },
                },
                ...
                yAxis: {
                    ...
                    axisLine: { show: !1 },
                    axisTick: { show: !1 },
                    axisLabel: { color: o.text, fontSize: 11.5, fontFamily: b },
                },
                series: [
                    {
                        type: "custom",
                        renderItem: (e, t) => {
                            const o = t.value(0),
                                ...
                                a = t.coord([t.value(2), o]),
                                n = 0.55 * t.size([0, 1])[1];
                            return {
                                type: "rect",
                                shape: { x: r[0], y: r[1] - n / 2, width: a[0] - r[0], height: n, r: 4 },
    ...
    "polar-bar": function (e, t, o) {
        ...
        return (
            a.setOption({
                textStyle: { fontFamily: b, color: o.textMuted },
                tooltip: { ...v(o).tooltip, formatter: "{b}: {c}" },
...
function z(e, t) {
    ...
    let a = 0,
        ...
        i = 0,
        l = -2;
    for (; r.length > n && o.length > a; )
        o[a] === r[n]
            ? ((0 !== a && " " !== o[a - 1] && "-" !== o[a - 1] && "_" !== o[a - 1]) || (i -= 6),
              l === a - 1 && (i -= 4),
              (l = a),
              (n += 1))
            : (i += 1),
            (a += 1);
    return r.length > n ? 1 / 0 : ((i += 0.1 * (o.length - r.length)), i);
}
function T() {
    const e = L.value.trim().toLowerCase();
    ($ = e
        ? C.map((t) => ({ it: t, s: z(e, t.keywords) }))
              .filter((e) => e.s !== 1 / 0)
              .sort((e, t) => e.s - t.s)
              .map((e) => e.it)
        : C.slice()),
    ...
    S ||
        ((C = (function () {
            ...
            return (
                n.forEach((e) => {
                    e.items.forEach((o) => {
                        t.push({
                            ...
                            section: e.label,
                            href: o.href,
                            keywords: `${o.text} ${e.label} ${o.key}`.toLowerCase(),
                        });
                    });
                }),
                [
                    { label: "Toggle theme", keywords: "theme dark light mode toggle", action: A },
                    {
                        label: "Open profile",
                ...
                ].forEach((e) => t.push({ kind: "action", ...e })),
                t
            );
        })()),
        ($ = C.slice()),
        (E = 0),
        ((S = document.createElement("div")).className = "cmdk-backdrop"),
        (S.innerHTML =
        ...
        (L = S.querySelector(".cmdk-input")),
        (M = S.querySelector(".cmdk-list")),
...
function B() {
    S && (S.remove(), (S = null), (L = null), (M = null), document.body.classList.remove("cmdk-open"));
}
var q = {
    print: /^print$/i,
...
var I = {
    ...
    refresh: (t) =>
        (function (t) {
            ...
            o && (o.classList.add("is-refreshing"), setTimeout(() => o.classList.remove("is-refreshing"), 700)),
    ...
    compose: () => {
        a({
            ...
            actions: [
                ...
                { label: "Save draft", variant: "outline", action: () => e("Draft saved", { variant: "success" }) },
                { label: "Send", variant: "primary", action: () => e("Message sent", { variant: "success" }) },
            ],
        });
    },
    newDeal: (t) =>
        (function (t) {
            const o = /event/i.test(t),
                ...
                n = /deal/i.test(t),
                i = /project/i.test(t),
                l = o ? "New event" : r ? "New task" : n ? "New deal" : i ? "New project" : "Create new";
            a({
                title: l,
                ...
                actions: [
                    ...
                    { label: "Create", variant: "primary", action: () => e(`${l} saved`, { variant: "success" }) },
                ],
            });
        })(j(t)),
    add: () => {
        a({
            ...
            actions: [
                { label: "Cancel", variant: "ghost" },
                { label: "Send invite", variant: "primary", action: () => e("Invite sent", { variant: "success" }) },
            ],
        });
    },
};
"admin" === document.body.dataset.shell &&
    ((function () {
        ...
        const {
                ...
                activeKey: e.dataset.page || "",
                breadcrumb: e.dataset.breadcrumb
        ...
        (a.innerHTML = t.trim()), e.insertBefore(a.content.firstElementChild, e.firstChild);
        const n = e.querySelector("main.main");
        (a.innerHTML = o.trim()),
            n &&
                (e.insertBefore(a.content.firstElementChild, n),
                (a.innerHTML = r.trim()),
                n.appendChild(a.content.firstElementChild));
    })(),
    (function () {
            ...
            r &&
                r.addEventListener("click", (a) => {
                    ...
                    t(n ? e : null),
                        ...
                        (function (e) {
                            try {
                                null === e ? sessionStorage.removeItem(c) : sessionStorage.setItem(c, String(e));
                            } catch (t) {}
                        })(n ? o : null);
                });
        });
    ...
    (function () {
        const e = document.querySelector(".sidebar"),
            o = document.querySelector(".sidebar-toggle");
        if (!e || !o) return;
        let r = document.querySelector(".sidebar-backdrop");
        r ||
            ((r = document.createElement("div")),
            (r.className = "sidebar-backdrop"),
            (r.hidden = !0),
        ...
        const a = () => {
            ...
            n = (e) => {
                document.body.classList.toggle("sidebar-rail", e),
                    o.setAttribute("aria-pressed", e ? "true" : "false"),
                    o.setAttribute("aria-label", e ? "Expand sidebar" : "Collapse sidebar");
                try {
        ...
        "1" === i && h() && n(!0),
            ...
            document.addEventListener("keydown", (t) => {
                "Escape" === t.key && e.classList.contains("open") && a();
            }),
            ...
            document.querySelectorAll(".sidebar .nav-toggle").forEach((e) => {
                e.addEventListener(
                    ...
                    (o) => {
                        ...
                        const r = e.closest(".nav-tree");
                        r &&
                            t(
                                e,
                                [...r.querySelectorAll(".nav-sublink")].map((e) => ({
    ...
    (function () {
        const r = document.querySelector(".tb-notifications");
        r &&
            r.addEventListener("click", (t) => {
                t.preventDefault(), t.stopPropagation();
                const n = (function () {
                    const e = p.filter((e) => e.unread).length,
                ...
                n.addEventListener("click", (t) => {
                    if (t.target.closest('[data-action="mark-all"]'))
                        return (
                            t.stopPropagation(),
                            p.forEach((e) => {
                                e.unread = !1;
                            }),
                            n.querySelectorAll(".panel-row.unread").forEach((e) => e.classList.remove("unread")),
                            n.querySelector(".panel-badge")?.remove(),
                            r.querySelector(".dot")?.style.setProperty("display", "none"),
                            void e("All notifications marked read", { variant: "success" })
                        );
                    const o = t.target.closest(".panel-row");
                    if (o) {
                        t.stopPropagation();
                        const e = parseInt(o.dataset.i, 10);
                        (p[e].unread = !1),
                            ...
                            a({
                                title: (i = p[e]).from,
                                size: "sm",
                                body: `\n      <div style="display:flex;gap:12px;align-items:flex-start;margin-bottom:14px">\n        <div style="width:36px;height:36px;border-radius:8px;background:var(--${"alert" === i.kind ? "red" : "task" === i.kind ? "green" : "blue"}-lt);color:var(--${"alert" === i.kind ? "red" : "task" === i.kind ? "green" : "blue"});display:flex;align-items:center;justify-content:center;flex-shrink:0">\n          ${"alert" === i.kind ? '<svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M8 1l7 13H1L8 1z"/><path d="M8 6v4"/></svg>' : "task" === i.kind ? '<svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M3 8l3 3 7-7"/></svg>' : '<svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="8" cy="8" r="6"/><path d="M8 5v3M8 11h.01"/></svg>'}\n        </div>\n        <div style="flex:1;min-width:0">\n          <div style="font-size:13.5px;color:var(--text);line-height:1.5;margin-bottom:6px">${i.text}</div>\n          <div style="font-size:11.5px;color:var(--text-muted)">${i.time}</div>\n        </div>\n      </div>\n    `,
                                actions: [
                    ...
                    o(r, n, { className: "panel-notifications", width: 360 });
            });
        const n = document.querySelector(".tb-messages");
        n &&
            n.addEventListener("click", (t) => {
                t.preventDefault(), t.stopPropagation();
                const r = (function () {
                    const e = u.filter((e) => e.unread).length,
                        t = document.createElement("div");
                    return (
                        (t.className = "panel-content"),
                ...
                r.addEventListener("click", (t) => {
                    ...
                    o(n, r, { className: "panel-messages", width: 360 });
            });
        const i = document.querySelector(".tb-avatar");
        i &&
            i.addEventListener("click", (e) => {
                e.preventDefault(), e.stopPropagation(), t(i, m);
            });
        const l = document.querySelector(".sidebar-user .more-btn");
        l &&
            l.addEventListener("click", (e) => {
                e.preventDefault(), e.stopPropagation(), t(l, m);
            });
    })()),
    (async function () {
        ...
        if (!e.length) return;
        e.forEach((e) => {
            e.children.length || e.classList.contains("skeleton") || e.classList.add("skeleton", "chart-skeleton");
        });
        const [
            t,
            {
            ...
            f(() => import("./vendor-echarts-hUIyzMbB.js").then((e) => e.n), __vite__mapDeps([0, 1])),
            f(() => import("./vendor-echarts-hUIyzMbB.js").then((e) => e.i), __vite__mapDeps([0, 1])),
            f(() => import("./vendor-echarts-hUIyzMbB.js").then((e) => e.r), __vite__mapDeps([0, 1])),
            f(() => import("./vendor-echarts-hUIyzMbB.js").then((e) => e.t), __vite__mapDeps([0, 1])),
        ]);
        t.use([o, r, a, n, i, l, s, c, d, h, p, u, m, g, b, v, x, k, S]);
        const L = [];
        let M;
        (() => {
            const o = y();
            e.forEach((e) => {
                const r = w[e.dataset.chart];
                r &&
                    (e.classList.remove("skeleton", "chart-skeleton"),
                    L.push({ el: e, factory: r, instance: r(t, e, o) }));
            });
        })(),
            window.addEventListener("resize", () => {
                clearTimeout(M), (M = setTimeout(() => L.forEach((e) => e.instance.resize()), 120));
            });
        const C = () => {
            const e = y();
            L.forEach((o) => {
        ...
        new MutationObserver((e) => {
            e.some((e) => "data-theme" === e.attributeName) && C();
        }).observe(document.documentElement, { attributes: !0, attributeFilter: ["data-theme"] }),
            document.documentElement.addEventListener("themechange", C);
    })(),
    (async function () {
        const t = document.querySelectorAll("table[data-datatable]");
        if (!t.length) return;
        const { default: o } = await f(
            async () => {
                const { default: e } = await import("./vendor-tables-Yd668bHn.js").then((e) => e.t);
                return { default: e };
            },
            __vite__mapDeps([2, 1])
        );
        t.forEach((t) => {
            ...
            (t.hasAttribute("data-selectable") ||
                ...
                (function (e) {
                    const t = e.querySelector('thead input[type="checkbox"]'),
                        o = () => {
                            if (!t) return;
                            const o = e.querySelectorAll('tbody input[type="checkbox"]'),
                                r = [...o].filter((e) => e.checked).length;
                            (t.checked = r > 0 && r === o.length),
                                (t.indeterminate = r > 0 && o.length > r),
                                e.classList.toggle("has-selection", r > 0);
                            const a = e.closest(".card")?.querySelector(".bulk-selection-count");
                            a && (a.textContent = r ? `${r} selected` : "");
                        };
                    t &&
                        ...
                        e.addEventListener("change", (e) => {
                            e.target.closest('tbody input[type="checkbox"]') && o();
                        });
                })(t),
                t.hasAttribute("data-export") &&
                    (function (t, o) {
                        const r = (t.dataset.export || "export") + ".csv";
                        let a = t.closest(".card")?.querySelector("[data-export-btn]");
                        if (!a) {
                            const e = t.closest(".card")?.querySelector(".card-header");
                            if (!e) return;
                            (a = document.createElement("button")),
                                (a.type = "button"),
                                (a.className = "btn btn-outline btn-sm"),
                                a.setAttribute("data-export-btn", ""),
                                (a.textContent = "Export CSV");
                            let o = e.querySelector(".card-actions");
                            o ||
                                ((o = document.createElement("div")),
                                (o.className = "card-actions"),
                        ...
                        a.addEventListener("click", () => {
                            ...
                            const n = o.rows({ search: "applied", order: "applied" }).indexes();
                            for (let e = 0; n.length > e; e += 1) {
                                const r = o.row(n[e]).node();
                                if (!r) continue;
                                const i = [];
                                [...r.cells].forEach((e, t) => {
                                    null !== a[t] && i.push(k(e.textContent.trim().replace(/\s+/g, " ")));
                                }),
                                    t.push(i.join(","));
                            }
                            !(function (e, t) {
            ...
            const n = t.closest(".dt-container")?.querySelector(".dt-search input");
            n && !n.hasAttribute("aria-label") && n.setAttribute("aria-label", "Search table");
        });
    })(),
    (function e() {
        if (e._wired) return;
        (e._wired = !0),
            document.addEventListener("keydown", (e) => {
                ("k" !== e.key && "K" !== e.key) || (!e.metaKey && !e.ctrlKey) || (e.preventDefault(), S ? B() : P());
            });
        const t = document.querySelector(".search-box input");
        if (t) {
            const e = (e) => {
                e.preventDefault(), t.blur(), P();
            };
    ...
    (function e() {
        ...
        document.addEventListener("click", (e) => {
            ...
            if (!r) return;
            const a = (function (e) {
                for (const [t, o] of Object.entries(q)) if (o.test(e)) return t;
                return null;
            })(r);
            a && (e.preventDefault(), I[a]?.(o));
        });
    })(),
    ...
    document.getElementById("inbox-root") &&
        f(() => import("./inbox-Cn00kCck.js").then((e) => e.initInbox()), __vite__mapDeps([3, 4, 1, 5, 6])),
    document.querySelector(".calendar-grid") &&
        f(() => import("./calendar-reenTeUh.js").then((e) => e.initCalendar()), __vite__mapDeps([7, 4, 1, 5])),
    document.querySelector(".settings-content") &&
        f(() => import("./settings-7ogjg0JM.js").then((e) => e.initSettings()), __vite__mapDeps([8, 4, 1, 5])),
    document.querySelector("[data-date-range], [data-rich-text], [data-multi-select]") &&
        f(() => import("./form-controls-v8wp39no.js").then((e) => e.initFormControls()), []),
    document.addEventListener("click", (e) => {
    ...
    document.addEventListener("click", (e) => {
        ...
        if (!r) return;
        const a = r.querySelector("[data-todo-counter]");
        if (!a) return;
        const n = r.querySelectorAll(".todo-row"),
            i = r.querySelectorAll(".todo-row.done");
        a.textContent = `${n.length - i.length} of ${n.length} remaining`;
    }),
    document.addEventListener("click", (e) => {
    ...
    document.addEventListener("click", (e) => {
        const o = e.target.closest(".card-opt-btn");
        o && (e.defaultPrevented || (e.preventDefault(), t(o, r)));
    }),
    document.addEventListener("click", (e) => {
    ...
    document.addEventListener("submit", (e) => {
        ...
        // e.preventDefault();
        // const o = t.querySelector('button[type="submit"], input[type="submit"]'),
        //     r = (o?.textContent || o?.value || "Saved").trim();
        // f(
        //     async () => {
        //         const { showToast: e } = await import("./toast-DgCSlJPv.js").then((e) => e.n);
        //         return { showToast: e };
        //     },
        //     __vite__mapDeps([4, 1])
        // ).then(({ showToast: e }) => e(`${r} ✓`, { variant: "success" })),
