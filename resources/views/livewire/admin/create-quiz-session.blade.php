      ...
      <div class="card-body">
        <form wire:submit="{{ $quizSession ? 'update' : 'save' }}">
          <div class="form-group">
            ...
            <input type="text" wire:model.blur="title" name="title" id="projectName" class="form-control" placeholder="">
              @error('title')
          ...
          <div class="form-group">
            ...
            <input type="text" wire:model="join_code" name="join_code" id="projectName" class="form-control" placeholder="">
              @error('join_code')
                  <div class="invalid-feedback d-block">{{ $message }}</div>
              @enderror
            <div class="form-help">A short, recognizable name. You can change it later.</div>
          ...
          {{-- <div class="form-row">
            <div class="form-group">
              <label class="form-label" for="startDate">Start Time</label>
              <input type="text" id="startDate" class="form-control">
            </div>
            <div class="form-group">
              <label class="form-label" for="endDate">End Time</label>
